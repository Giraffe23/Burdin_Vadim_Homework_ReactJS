...
export default class Details extends PureComponent {
	...
	static propTypes = {
		pokemon: PropTypes.arrayOf({
			...
			base_experience: PropTypes.string, location_area_encounters: PropTypes.string
		}),
	};
	...
	render() {
		const { pokemon, onLoadClick } = this.props;
		return (
			<Table dark hover>
				<thead>
					<tr>
						<td colspan="2"><Button onClick={onLoadClick} outline color="success" size="lg" block>Load details</Button></td>
					</tr>
					<tr>
						<th>Key</th>
						<th>Value</th>
